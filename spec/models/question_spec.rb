  ...
  describe 'when parameters are expected' do
    ...
    describe 'when we try and create the same question' do
      it 'fails to create' do
        ...
        expect { duplicated_question.save }.to raise_error(an_instance_of(Sequel::UniqueConstraintViolation).and having_attributes(message: "SQLite3::ConstraintException: UNIQUE constraint failed: questions.user_id, questions.title"))
      end
    end
  end
end
